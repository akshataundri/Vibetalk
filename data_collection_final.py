...
count = len(oss.listdir("C:\\Users\\DELL\\Downloads\\NEW_SIGN_ISL\\ISL\\ISL\\A\\"))
c_dir = 'A'
...
cv2.imwrite("C:\\Users\\DELL\\Downloads\\NEW_SIGN_ISL\\ISL\\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread("C:\\Users\\DELL\\Downloads\\NEW_SIGN_ISL\\ISL\\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:\\Users\\DELL\\Downloads\\NEW_SIGN_ISL\\ISL\\ISL\\" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:\\Users\\DELL\\Downloads\\NEW_SIGN_ISL\\ISL\\ISL\\A\\" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
