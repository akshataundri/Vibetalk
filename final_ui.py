...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=50, y=50, width=400, height=300)
        ...
        self.T1.place(x=50, y=370)
        self.T1.config(text="Character:", font=("Courier", 16, "bold"))

        self.panel3 = tk.Label(self.root)
        self.panel3.place(x=200, y=370)
        self.panel3.config(text="", font=("Courier", 16))

        # Sentence display
        self.T3 = tk.Label(self.root)
        self.T3.place(x=50, y=410)
        self.T3.config(text="Sentence:", font=("Courier", 16, "bold"))

        self.panel5 = tk.Label(self.root)
        self.panel5.place(x=180, y=410, width=800)
        self.panel5.config(text="", font=("Courier", 16), wraplength=800)

        # Suggestions label
        self.T4 = tk.Label(self.root)
        self.T4.place(x=50, y=450)
        self.T4.config(text="Suggestions:", fg="red", font=("Courier", 16, "bold"))

        # Suggestion buttons
        self.b1 = tk.Button(self.root, width=15)
        self.b1.place(x=200, y=450)

        self.b2 = tk.Button(self.root, width=15)
        self.b2.place(x=400, y=450)

        self.b3 = tk.Button(self.root, width=15)
        self.b3.place(x=600, y=450)

        self.b4 = tk.Button(self.root, width=15)
        self.b4.place(x=800, y=450)

        # Control buttons
        self.speak = tk.Button(self.root)
        self.speak.place(x=950, y=500)
        self.speak.config(text="Speak", font=("Courier", 14), width=8, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1050, y=500)
        self.clear.config(text="Clear", font=("Courier", 14), width=8, command=self.clear_fun)
                ...
                if hands[0]:
                    ...
                    if image.all:
                        ...
                        if handz[0]:
                            ...
                            self.panel3.config(text=self.current_symbol, font=("Courier", 16))

                            self.b1.config(text=self.word1, font=("Courier", 12), command=self.action1)
                            self.b2.config(text=self.word2, font=("Courier", 12), command=self.action2)
                            self.b3.config(text=self.word3, font=("Courier", 12), command=self.action3)
                            self.b4.config(text=self.word4, font=("Courier", 12), command=self.action4)

                self.panel5.config(text=self.str, font=("Courier", 16))
        except Exception:
