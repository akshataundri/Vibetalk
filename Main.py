...
class Application:
    ...
    def __init__(self):
        ...
        # Main title
        self.T = tk.Label(self.root, text="Sign Language To Text Conversion", font=("Arial", 20, "bold"), bg='#2C3E50', fg='white')
        self.T.place(x=400, y=10)

        # Camera feed panel
        camera_frame = tk.Frame(self.root, bg='#34495E', relief=tk.RAISED, bd=2)
        camera_frame.place(x=50, y=50, width=400, height=300)
        
        tk.Label(camera_frame, text="Camera Feed", font=("Arial", 12, "bold"), bg='#34495E', fg='white').pack(pady=5)
        
        self.panel = tk.Label(camera_frame, bg='black')
        self.panel.pack(padx=10, pady=5, fill=tk.BOTH, expand=True)

        # Hand landmarks panel
        hand_frame = tk.Frame(self.root, bg='#34495E', relief=tk.RAISED, bd=2)
        hand_frame.place(x=500, y=50, width=300, height=300)
        
        tk.Label(hand_frame, text="Hand Landmarks", font=("Arial", 12, "bold"), bg='#34495E', fg='white').pack(pady=5)
        
        self.panel2 = tk.Label(hand_frame, bg='black')
        self.panel2.pack(padx=10, pady=5, fill=tk.BOTH, expand=True)

        # Current character display
        char_frame = tk.Frame(self.root, bg='#34495E', relief=tk.RAISED, bd=2)
        char_frame.place(x=850, y=50, width=300, height=100)
        
        tk.Label(char_frame, text="Detected Character", font=("Arial", 12, "bold"), bg='#34495E', fg='white').pack(pady=5)
        
        self.panel3 = tk.Label(char_frame, text="", font=("Arial", 24, "bold"), bg='#2C3E50', fg='#E74C3C', width=5)
        self.panel3.pack(pady=10)

        # Sentence display
        sentence_frame = tk.Frame(self.root, bg='#34495E', relief=tk.RAISED, bd=2)
        sentence_frame.place(x=50, y=370, width=900, height=80)
        
        tk.Label(sentence_frame, text="Translated Text", font=("Arial", 12, "bold"), bg='#34495E', fg='white').pack(pady=5)
        
        self.panel5 = tk.Label(sentence_frame, text="", font=("Arial", 14), bg='#ECF0F1', fg='#2C3E50', wraplength=880)
        self.panel5.pack(padx=10, pady=5, fill=tk.BOTH, expand=True)

        # Suggestions label
        suggestions_frame = tk.Frame(self.root, bg='#34495E', relief=tk.RAISED, bd=2)
        suggestions_frame.place(x=50, y=470, width=900, height=160)
        
        tk.Label(suggestions_frame, text="Word Suggestions", font=("Arial", 12, "bold"), bg='#34495E', fg='white').pack(pady=5)

        # Suggestion buttons
        buttons_frame = tk.Frame(suggestions_frame, bg='#34495E')
        buttons_frame.pack(pady=5)
        
        self.b1 = tk.Button(buttons_frame, width=15, font=("Arial", 10), bg='#3498DB', fg='white', relief=tk.RAISED)
        self.b1.grid(row=0, column=0, padx=5)
        
        self.b2 = tk.Button(buttons_frame, width=15, font=("Arial", 10), bg='#3498DB', fg='white', relief=tk.RAISED)
        self.b2.grid(row=0, column=1, padx=5)
        
        self.b3 = tk.Button(buttons_frame, width=15, font=("Arial", 10), bg='#3498DB', fg='white', relief=tk.RAISED)
        self.b3.grid(row=0, column=2, padx=5)
        
        self.b4 = tk.Button(buttons_frame, width=15, font=("Arial", 10), bg='#3498DB', fg='white', relief=tk.RAISED)
        self.b4.grid(row=0, column=3, padx=5)

        # Control buttons
        control_frame = tk.Frame(self.root, bg='#2C3E50')
        control_frame.place(x=970, y=370, width=200, height=160)
        
        self.speak = tk.Button(control_frame, text="SPEAK", font=("Arial", 12, "bold"), 
                              bg='#27AE60', fg='white', width=12, height=2,
                              command=self.speak_fun, relief=tk.RAISED, bd=3)
        self.speak.pack(pady=10)
        
        self.clear = tk.Button(control_frame, text="CLEAR", font=("Arial", 12, "bold"), 
                              bg='#E74C3C', fg='white', width=12, height=2,
                              command=self.clear_fun, relief=tk.RAISED, bd=3)
                ...
                if hands[0]:
                    ...
                    if image.all:
                        ...
                        if handz[0]:
                            ...
                            self.panel3.config(text=self.current_symbol, font=("Arial", 24, "bold"))

                            self.b1.config(text=self.word1, font=("Arial", 10), command=self.action1)
                            self.b2.config(text=self.word2, font=("Arial", 10), command=self.action2)
                            self.b3.config(text=self.word3, font=("Arial", 10), command=self.action3)
                            self.b4.config(text=self.word4, font=("Arial", 10), command=self.action4)
